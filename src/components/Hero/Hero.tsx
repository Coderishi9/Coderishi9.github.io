...
const Hero = () => {
  ...
  return (
    <div className={styles.hero}>
      ...
      <h2 className={styles.name}>Rishi Raj Singh. &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</h2>
        ...
        <p className={styles.description}>
            I bring over 3 years of experience specializing in Backend development, Python, Machine learning
            and Data Analytics. I have recently graduated from {" "}&nbsp;
            <Link
